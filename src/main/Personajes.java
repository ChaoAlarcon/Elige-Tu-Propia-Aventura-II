	...
	public void ElegirPersonaje() {
		...
		while (opcionPersonaje < 1 || opcionPersonaje > 3) {
			...
			if (opcionPersonaje == 2) {
			    ...
			    System.out.println("Habilidad especial ("+ ConectarBDD.consultarDatosint("nombreHabilidad", "ataques", "id_personajes = 2") +"): " + ConectarBDD.consultarDatosint("datosHabilidad", "ataques", "id_personajes = 2") +" puntos de escudo. " + ConectarBDD.consultarDatosint("descripcionHabilidad", "ataques", "id_personajes = 2")+".");
			...
			if (opcionPersonaje == 3) {
			    ...
			    System.out.println("Habilidad especial ("+ ConectarBDD.consultarDatosint("nombreHabilidad", "ataques", "id_personajes = 3") +"): " + ConectarBDD.consultarDatosint("datosHabilidad", "ataques", "id_personajes = 3") +" puntos de escudo. " + ConectarBDD.consultarDatosint("descripcionHabilidad", "ataques", "id_personajes = 3")+".");
