...
public class CreacionJugador {
	public CreacionJugador(String string, int vida, int ataqueBasico, int ataqueFuerte, int especial) {
	}

	public static boolean isValido(String nombre) {
		return nombre.equalsIgnoreCase("cambises") || nombre.equalsIgnoreCase("bastet")
