...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-06-2025 a las 23:20:39
...
CREATE TABLE `ataques` (
  ...
  `precisionHabilidad` int(11) DEFAULT NULL
...
INSERT INTO `ataques` (`id`, `id_ataques`, `nombreBasico`, `danoBasico`, `descripcionBasico`, `precisionBasico`, `nombreFuerte`, `danoFuerte`, `descripcionFuerte`, `precisionFuerte`, `nombreHabilidad`, `datosHabilidad`, `descripcionHabilidad`, `precisionHabilidad`) VALUES
...
(3, 2, 'Pasillo oscuro', NULL, 2, 3, 1, 1, 1),
(4, 3, 'Sala Roja', 3, NULL, 5, 3, 2, 1),
(5, 4, 'Sala Verde', 4, 3, 1, 1, 2, 1),
(6, 5, 'Sala Blanca', NULL, 4, 6, 6, 3, 2),
(7, 6, 'Sala Azul', 5, NULL, 4, 4, 3, 1),
(8, 7, 'Sala Morada', 6, NULL, 2, 5, 4, 1),
(9, 8, 'Templo de Ammit', NULL, 5, 1, 2, 4, 3),
...
(1, 1, 'Ánuket', 1050, 'Muerte antes de Boss', '5 Puzzles ArmaTocha', 'Muerte Ammet', 'Sacrificio contra Boss', 'Victoria boss', 1),
(2, 2, 'Bastet', 900, 'Muerte antes de Boss', '5 Puzzles ArmaTocha', 'Muerte Ammet', 'Sacrificio contra Boss', 'Victoria boss', 2),
(3, 3, 'Gerald', 1200, 'Muerte antes de Boss', '5 Puzzles ArmaTocha', 'Muerte Ammet', 'Sacrificio contra Boss', 'Victoria boss', 3);
