...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-06-2025 a las 21:23:43
...
(1, 1, 'Porrazo de cetro', 80, 'Ánuket empuña su cetro y le da un golpe al enemigo', 100, 'Invocación de bestias', 300, 'Ánuket invoca dos golems que muerden al enemigo', 70, 'Aegis etéreo', 75, 'Ánuket invoca un escudo alrededor suyo que reduce el daño recibido'),
(2, 2, 'Lanzamiento de dagas', 90, 'Bastet lanza afiladas dagas contra su enemigo', 100, 'Flor fatal', 250, 'Bastet lanza dagas impregnadas con veneno', 90, 'Alma voraz', 300, 'Bastet lanza un hechizo que restaura algo de su salud'),
(3, 3, 'Espadazo', 100, 'Gerald empuña su espada y corta al enemigo', 100, 'Doble espadazo', 275, 'Gerald empuña sus dos espadas para realizar un combo de cortes', 75, 'Modo berserker', 200, 'Gerald enfurece y recibe un aumento de daño');
...
(1, 1, 'Mirada punzante', 40, 'El cactus te mira fijamente y sientes como se te pinchara con todas sus espinas', 'Lanzamiento de espinas', 80, 'El cactus se hincha y dispara muchas espinas', 'Explosión floral', 100, 'Del cactus crece una flor que esparce una nube de veneno'),
(2, 2, 'Lanzamiento de hueso', 60, 'Cambises se arranca una costilla para lanzartela', 'Espadazo', 120, 'Cambises empuña su espada rota para hacer un corte', 'Danza de muerto', 1, 'Cambises la Momia invoca a los muert-\r\nERROR class_terreno:~random'),
(3, 3, 'Puñetazo de magma', 70, 'El Golem alza su puño de rocas ardientes y lo deja caer sobre ti', 'Llamarada', 140, 'Los ojos del Golem se encienden y de ellos salen unas potentes llamas', 'Invocación de llamas', 1, 'El Golem alza sus brazos y del suelo empiezan a surgi-\r\nERROR class_terreno:~random'),
(4, 4, 'Ramazo', 80, 'El Ent estrira las ramas de su brazo para apuñalarte', 'Martillo de madera', 160, 'El Ent forma un martillo gigante con sus brazos para aplastarte', 'Florecer de verano', 1, 'De las ramas del Ent empiezan a brotar hoj-\r\nERROR class_terreno:~random'),
(5, 5, 'Salpicar', 90, 'Salomón el Salmón Gigante le pega con la cola a la superficie del río para lanzar una gran ola de agua', 'Hidrocañón', 180, 'Salomón el Salmón Gigante acumula agua en su boca para luego lanzarla con muchísima presión', 'Salto de montañas', 2, 'Salomón el Salmón Gigante salta hacia el ciel- \r\nERROR class_terreno:~random\r\nERROR class_clima:~random'),
(6, 6, 'Bola de fuego infernal', 100, 'Tahorki conjura un hechizo para lanzar una bola de fuego negro', 'Luvia de rayos', 200, 'Tahorki conjura un hechizo que nubla el cielo, y de las nubes empiezan a caer rayos', 'Invocación de muertos', 2, 'Tahorki empieza a conjurar un hechizo, del suelo empiezan a sur- \r\nERROR class_terreno:~random\r\nERROR class_clima:~random'),
(7, 7, 'class_ataqueBasico:notfound', 150, 'Del extraño ser, salen una ráfaga de cubos disparados', 'class_ataqueFuerte:notfound', 350, 'Del extraño ser salen disparados cubos al cielo que empiezan a formar un cubo gigante que deja caer encima tuyo', 'class_habilidad:notfound', 3, 'ERROR class_terreno:~random\r\nERROR class_clima:~random\r\nERROR class_hora~random');
...
(1, 1, 'Nublado', 20, '+precision', 0, NULL),
(2, 2, 'Despejado', 30, '+precision', 0, NULL),
(3, 3, 'Calor extremo', 0, NULL, 20, '-precision'),
(4, 4, 'Tormenta de nieve', 0, NULL, 15, '-precision'),
(5, 5, 'Tormenta de arena', 0, NULL, 10, '-precision'),
...
(1, 1, 'Mañana', 50, '+ataque', 0, NULL),
(2, 2, 'Mediodía', 25, '+ataque', 0, NULL),
(3, 3, 'Tarde', 0, NULL, 15, '-ataque'),
(4, 4, 'Noche', 0, NULL, 30, '-ataque'),
...
(1, 1, 'Ánuket', 1050, 'enemigos.getEnemigos().get(batallaActual) + \" Te da el golpe de gracia y acaba contigo. Contigo derrotado no queda tiempo para que nadie pueda salvar Eazima.', 'No consigues liberar a Ammit y ves cómo mata a Obi, después Ammit se dirige hacia ti y acaba contigo.', 'El extraño ser acaba contigo y pronto conseguirá salir de la Pirámide y acabará con toda Eazima.', 'Con ese ataque, consigues acabar con el ser y la sala empieza a desaparecer poco a poco y cuando desaparece completamente, ves que toda la pirámide y el portal han desaparecido también, has conseguido acabar con el mal que amenazaba a Eazima.', 'Gracias a la bendición de Ammit lanzas un ataque que acaba con el ser de un golpe.\\nLa sala empieza a desaparecer poco a poco y cuando desaparece completamente, ves que toda la pirámide y el portal han desaparecido también, has conseguido acabar con el mal que amenazaba a Eazima.', 1),
(2, 2, 'Bastet', 900, 'enemigos.getEnemigos().get(batallaActual) + \" Te da el golpe de gracia y acaba contigo. Contigo derrotado no queda tiempo para que nadie pueda salvar Eazima.', 'No consigues liberar a Ammit y ves cómo mata a Obi, después Ammit se dirige hacia ti y acaba contigo.', 'El extraño ser acaba contigo y pronto conseguirá salir de la Pirámide y acabará con toda Eazima.', 'Con ese ataque, consigues acabar con el ser y la sala empieza a desaparecer poco a poco y cuando desaparece completamente, ves que toda la pirámide y el portal han desaparecido también, has conseguido acabar con el mal que amenazaba a Eazima.', 'Gracias a la bendición de Ammit lanzas un ataque que acaba con el ser de un golpe.\\nLa sala empieza a desaparecer poco a poco y cuando desaparece completamente, ves que toda la pirámide y el portal han desaparecido también, has conseguido acabar con el mal que amenazaba a Eazima.', 2),
(3, 3, 'Gerald', 1200, 'enemigos.getEnemigos().get(batallaActual) + \" Te da el golpe de gracia y acaba contigo. Contigo derrotado no queda tiempo para que nadie pueda salvar Eazima.', 'No consigues liberar a Ammit y ves cómo mata a Obi, después Ammit se dirige hacia ti y acaba contigo.', 'El extraño ser acaba contigo y pronto conseguirá salir de la Pirámide y acabará con toda Eazima.', 'Con ese ataque, consigues acabar con el ser y la sala empieza a desaparecer poco a poco y cuando desaparece completamente, ves que toda la pirámide y el portal han desaparecido también, has conseguido acabar con el mal que amenazaba a Eazima.', 'Gracias a la bendición de Ammit lanzas un ataque que acaba con el ser de un golpe.\\nLa sala empieza a desaparecer poco a poco y cuando desaparece completamente, ves que toda la pirámide y el portal han desaparecido también, has conseguido acabar con el mal que amenazaba a Eazima.', 3);
...
(1, 'Adivina el número', 'Tienes que adivinar un número del 1 al 20.', 10),
(2, 'Acertijo Esfinge', 'Tienes que resolver el acertijo.', 15),
(3, 'Ahorcado', 'Tienes que adivinar la palabra letra por letra.', 20),
(4, 'Piedra papel o tijeras.', 'Elige piedra, papel o tijeras.\r\nPiedra gana a tijeras.\r\nPapel gana a piedra.\r\nTijeras gana a papel.', 25),
(5, 'Trivial', 'Tienes que contestar correctamente a todas las preguntas.', 30);
...
(1, 1, 'Suelo de hierba', 50, '+vida', 0, NULL),
(2, 2, 'Suelo de cristales mágicos', 25, '+vida', 0, NULL),
(3, 3, 'Suelo arenoso', 0, NULL, 15, '-vida'),
(4, 4, 'Suelo de hielo', 0, NULL, 25, '-vida'),
(5, 5, 'Suelo de magma', 0, NULL, 30, '-vida'),
